...
# --- Configuration ---
dataset_folder = r"separated_images\train"  # Your dataset folder path
output_folder = r"C:\Users\muthumaniraj\Documents\artifacts\dataset\train\huntingtool"  # Output folder for individual images
font_size = 30
